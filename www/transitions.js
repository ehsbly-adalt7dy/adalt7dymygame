(function () {
  ...
  const CSS = `
    ...
    body.__page-out {
      pointer-events: none;
      animation: __slideOut 0.22s cubic-bezier(0.4, 0, 1, 1) forwards;
    }
    body.__page-in {
      animation: __slideIn 0.28s cubic-bezier(0, 0, 0.2, 1) both;
    }
    body.__page-in-back {
      animation: __slideInBack 0.28s cubic-bezier(0, 0, 0.2, 1) both;
    }
    body.__page-out-back {
      pointer-events: none;
      animation: __slideOutBack 0.22s cubic-bezier(0.4, 0, 1, 1) forwards;
    }
